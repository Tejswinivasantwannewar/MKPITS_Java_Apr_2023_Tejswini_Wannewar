...
<div class="container col-lg-6" >
    ...
    <form action="Login.jsp" method="post"  >
        ...
        <table border="0" cellpadding="10" align="center" cellspacing="2" class="table-primary" >
            ...
            <td>  <button type="button" class="btn btn-dark btn-lg">LogIn</button></td>
            <td>  <button type="button" class="btn btn-dark btn-lg"><a href="Registration_Form.jsp"> Registration</a></button>   </td>
